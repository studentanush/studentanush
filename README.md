...
> *Building scalable web applications and intelligent systems — one commit at a time.*

I'm a Computer Engineering student passionate about crafting full-stack experiences that are fast, reliable, and AI-augmented. I work at the intersection of real-time systems, AI pipelines, and automated DevOps workflows.

- Currently building real-time collaborative apps with WebSockets and event-driven architecture
- Exploring RAG pipelines and multi-agent orchestration for AI integration
- Automating CI/CD with GitHub Actions and containerizing with Docker
- Deepening expertise in TypeScript, system design, and distributed systems
...
|---------|-------------|-------|
| **Spotify Clone** | Full-stack music streaming platform with Cloudinary media management and custom authentication | React · Node.js · MongoDB · Cloudinary |
| **MindVault** | Productivity tool for fast information retrieval and personal knowledge management | MERN · REST API |
| **[QUIZZCO.AI](http://QUIZZCO.AI)** | AI-powered automated assessment platform with intelligent quiz generation | AI · Node.js · React |
